# Generated by Powerlevel10k configuration wizard on 2020-02-01 at 17:41 GMT.
...
() {
  ...
  # # CUSTOM TRANSIENT STUFFS Above is set to off and we simulate the above using custom functions
  ...
  #   p10k display '1/right/^time'=show 
  #   p10k display '1/left/^prompt_char'=show
  #   p10k display '1/left/prompt_char'=hide
  # }
  # function p10k-on-post-prompt() {
  #   p10k display 'empty_line'=hide
   
  #   p10k display '1/right/^time'=hide
  #   p10k display '1/left/^prompt_char'=hide
  #   p10k display '1/left/prompt_char'=show
  # }
